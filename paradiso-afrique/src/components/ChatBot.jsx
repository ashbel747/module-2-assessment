    ...
    <div>
      ...
      <div className="fixed inset-0 z-50 bg-[url('assets/chatbot-section-background.jpeg')] bg-cover bg-top bg-no-repeat flex flex-col overflow-y-auto" id="chatbot">
        <div className="px-4 py-3 flex justify-between items-center">
          ...
          <h2 className="text-3xl font-italianno text-center inline-block bg-white p-2">Chat With Our Chef</h2>
        ...
        <div className="max-w-sm bg-white dark:bg-gray-800 flex flex-col ml-2 rounded mt-6"><span className="font-italianno text-2xl text-black dark:text-white text-center p-3">Ask Chef Kofi</span>
          ...
          {/* Input Place */}
          <div className="flex items-center gap-2 px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded">
            <input
              type="text"
      ...
      <div className="px-3 mt-8">
        <ul className="space-y-4">
          <li className="bg-orange-100 dark:bg-gray-800 px-4 py-2 rounded w-96 cursor-pointer hover:bg-orange-200">
